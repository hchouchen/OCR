...
#https://github.com/hchouchen/CHINESE-OCR/blob/master/train/pytorch-train/models/crnn.py#
...
class BidirectionalLSTM(nn.Module):
    ...
    def forward(self, input):
        recurrent, _ = data_parallel(self.rnn, input,self.ngpu)#[T,b,h * 2]

        T, b, h = recurrent.size()
        t_rec = recurrent.view(T * b, h)
        output = data_parallel(self.embedding, t_rec,self.ngpu)#[T*b,nOut]
